...
CORS(courses, origins=['http://localhost:3000', 'https://kristiana-jedi-academy.herokuapp.com'], supports_credentials=True) 
CORS(padawans, origins=['http://localhost:3000', 'https://kristiana-jedi-academy.herokuapp.com'], supports_credentials=True)
CORS(enrollments, origins=['http://localhost:3000', 'https://kristiana-jedi-academy.herokuapp.com'], supports_credentials=True)
